...
const e2e = async () => {
    ...
    const treeAccount = await ConcurrentMerkleTreeAccount.fromAccountAddress(connectionWrapper, treeWallet.publicKey);
    ...
    const assetId = await getCompressedNftId(treeWallet.publicKey, leafIndex);
    ...
    await transferAsset(connectionWrapper, ownerWallet, newOwnerWallet, assetId.toBase58());
